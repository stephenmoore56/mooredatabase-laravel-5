...
/*!50001 VIEW `trip_view` AS select `trip`.`id` AS `id`,`trip`.`location_id` AS `location_id`,`trip`.`trip_date` AS `trip_date`,`trip`.`notes` AS `notes` from `trip` */;
...
-- Dump completed on 2017-03-22 13:30:15
