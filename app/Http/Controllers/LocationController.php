...
class LocationController extends \BaseController {
    ...
    public function index() {
        ...
        return View::make('admin/locations/list')->with('locations', $locations);
    }
    ...
    public function create() {
        ...
        return View::make('admin/locations/create')->with($data);
    }
    ...
    public function edit($id) {
        ...
        return View::make('admin/locations/edit')
            ->with($data)
    ...
    private function getDataForDropdowns() {
        $countries       = ['US' => 'US'];
        $states          = ['MN' => 'MN'];
        $counties        = DB::table('county')->orderBy('county_name', 'asc')->lists('county_name', 'county_name');
        $ecs_subsections = DB::table('ecs_subsection')->orderBy('name', 'asc')->lists('name', 'id');
        $data            = [
            'countries'       => $countries,
            'states'          => $states,
            'counties'        => $counties,
