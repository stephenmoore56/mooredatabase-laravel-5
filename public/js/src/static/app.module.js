System.register(["@angular/core", "@angular/platform-browser", "./app.component", "./home.component", "./certifications.component", "./education.component", "./training.component", "./contact.component", "./navbar.component", "./navbarbrand.component", "./app.routes"], function (exports_1, context_1) {
    "use strict";
    ...
    var core_1, platform_browser_1, app_component_1, home_component_1, certifications_component_1, education_component_1, training_component_1, contact_component_1, navbar_component_1, navbarbrand_component_1, app_routes_1, AppModule;
    return {
        setters: [
            function (core_1_1) {
                core_1 = core_1_1;
